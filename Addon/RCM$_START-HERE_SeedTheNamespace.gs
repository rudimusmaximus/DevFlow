...
(function (nested) {
  nested.Enums = {
    ...
    //************************************************** SEMANTIC VERSIONING
    CURRENT_ADDON_VERSION           : "0.4.1-topLevelAddon.4",  //RCM$.ThisAddon.Enums.CURRENT_ADDON_VERSION *** used in GO LISTING AND DEV FLOW ****
    ...
    HTML_SIDEBAR_FILE : "Addon/html/Sidebar.html",
